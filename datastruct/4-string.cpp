...
inline String& String::operator =(const String &rhs)
{
	if(this!=&rhs)
	{
		...
		{
			_buffer=new char[_size+1];
			strncpy(_buffer,rhs._buffer,_size);
			_buffer[_size]=0;
		}
	}
	return *this;
...
bool String::operator ==(const String &rhs)
{
	if(_size!=rhs._size)
		return false;
	return strcmp(_buffer,rhs._buffer) ? false : true;
}

bool String::operator ==(const char *s)
{
	return strcmp(_buffer,s) ? false : true;
}
...
String& String::operator +=(const String &rhs)
{
	if(rhs._buffer)
	{
		...
		delete [] _buffer;
		_buffer=new char[_size+1];
		strcpy(_buffer,temp._buffer);
		strcpy(_buffer+temp._size,rhs._buffer);
	}
	return *this;
}
