...
__ENTER_FUNCTION
	...
	return strUtil::Strtoint(_curRow[fieldIndex]);
__LEAVE_FUNCTION
	return -1;
}
...
__ENTER_FUNCTION
	Assert(fieldIndex >= 0 && fieldIndex < _fieldCount);
	return strUtil::Strtouint(_curRow[fieldIndex]);
...
int64	 CDBResult::getFieldAsInt64(const int fieldIndex) const
{
	__ENTER_FUNCTION
	Assert(fieldIndex >= 0 && fieldIndex < _fieldCount);
	return strUtil::Strtoint64(_curRow[fieldIndex]);
	__LEAVE_FUNCTION
	return -1;
}
...
uint64	 CDBResult::getFieldAsUint64(const int fieldIndex) const
{
	__ENTER_FUNCTION
	Assert(fieldIndex >= 0 && fieldIndex < _fieldCount);
	return strUtil::Strtouint64(_curRow[fieldIndex]);
	__LEAVE_FUNCTION
	return -1;
}
...
__ENTER_FUNCTION
	Assert(fieldIndex >= 0 && fieldIndex < _fieldCount);
	return strUtil::Strtof(_curRow[fieldIndex]);
__LEAVE_FUNCTION
	return 0.0f;
}
